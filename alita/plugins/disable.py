...
from alita.plugins.helper_funcs.handlers import CMD_STARTERS
from alita.plugins.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    from alita.plugins.helper_funcs.chat_status import user_admin, is_user_admin
    from telegram.ext.dispatcher import run_async

    from alita.plugins.sql import disable_sql as sql
